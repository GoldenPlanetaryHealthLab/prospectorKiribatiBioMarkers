...
fusen::fill_description(
  pkg = here::here(),
  fields = list(
    Title = "Kiribati Biomarkers Data Distribution Package",
    Description = "This package provides access to biomarker data collected in Kiribati.",
    `Authors@R` = c(
      person("Tinashe", "Tapera", email = "ttapera@hsph.harvard.edu", role = c("aut", "cre")),
      person("Jessica", "Mason", email = "jzm@hsph.harvard.edu", role = c("com")),
